...
# Lee las variables de entorno USER y PWD.
# Estas son las variables que el pipeline de CI establece.
# Si no están definidas (ej. ejecución local sin estas variables seteadas),
# usa valores por defecto.
user     = os.getenv("USER",  "dbadmin") # Corregido: Leer "USER"
pwd      = os.getenv("PWD",   "@Infernity1") # Corregido: Leer "PWD"
# ------------------------------------------------------
